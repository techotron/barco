...
foreach ($images as &$image) {
  ...
  if (!(($image == '.') or ($image == '..'))) {
    ...
    echo '<div class="img"><a href="./' . $screenName . '.php"><img src="./imgs/' . $image . '" alt="' . $displayScrnName . ' Display" width="100%"></a><div class="desc">' . $displayScrnName . ' Display</div></div>';
